      ...
      >
        <div className="intro">
          ...
          <p>
            ...
            the years with no sings of its immense capabilities slowing down.
            Its been better than us at maths, at logic games like chess for many
            years already. One domain previously unaffected by such things is
            the creative world.
          </p>
          <p>
            ...
            ability to express emotion though these mediums is found nowhere
            else, until now.
          </p>
          <p>
        ...
        <p>
          I found myself getting lost in the creation of these various images,
          the speed and quality of the art produced cant really be denied. Isn't
          art something more than just the 'look'? no actual feeling or emotion
          played any role in creating these, there is something very detached
          and clinical about it.. but does that matter?
        </p>
